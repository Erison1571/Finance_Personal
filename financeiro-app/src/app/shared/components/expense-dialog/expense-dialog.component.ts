...
@Component({
  ...
  template: `
    <h2 mat-dialog-title>{{ isEdit ? 'Editar' : 'Nova' }} Despesa</h2>
      ...
      <mat-dialog-content>
        <div class="form-row">
          <mat-form-field appearance="outline" class="full-width">
            ...
            <input matInput formControlName="description" placeholder="Descrição da despesa">
  ...
  private initForm() {
    ...
    if (this.isEdit && this.data.expense) {
      ...
      this.form.patchValue({
        ...
        dateExpected: new Date(expense.dateExpected),
