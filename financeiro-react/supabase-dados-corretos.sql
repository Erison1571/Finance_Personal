-- Script com os DADOS CORRETOS baseados na imagem do usuário
-- Total: R$ 9.131,93 (38 despesas)
...
-- Inserir categorias REAIS (baseadas na imagem)
...
-- Inserir tipos REAIS (baseados na imagem)
...
-- Inserir despesas REAIS (baseadas na imagem - 38 despesas totalizando R$ 9.131,93)
-- Despesas efetivadas: R$ 7.151,17 (34 despesas)
-- Despesas à efetivar: R$ 1.980,76 (4 despesas)
INSERT INTO expenses (id, kind, category_id, type_id, val, date_prevista, date_efetiva, obs, is_mensal, series_id, created_at, updated_at) VALUES 
...
-- Inserir receitas REAIS (baseadas na imagem)
INSERT INTO incomes (id, kind, category_id, type_id, val, date_prevista, date_efetiva, obs, is_mensal, series_id, created_at, updated_at) VALUES 
